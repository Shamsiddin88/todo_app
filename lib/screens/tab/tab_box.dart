    ...
    return Scaffold(
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: BottomNavigationBar(
          ...
          unselectedLabelStyle: AppTextStyle.latoMedium
              .copyWith(fontSize: 12.w, color: AppColors.c_AFAFAF),
          selectedLabelStyle: AppTextStyle.latoMedium
              .copyWith(fontSize: 12.w, color: AppColors.white),
            ...
            BottomNavigationBarItem(
                icon: SvgPicture.asset(
                  ...
                  colorFilter: ColorFilter.mode(
                      AppColors.white.withOpacity(0.3), BlendMode.srcIn),
                ),
                label: "Index",
