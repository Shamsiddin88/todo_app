        ...
        TextButton(
            onPressed: () {
              ...
              StorageRepository.setBool(
                  key: StorageKeys.onBoardingRoute, value: true);
            },
            child: Text(
              "SKIP",
                  ...
                  child: PageView(
                      ...
                      children: List.generate(
                          ...
                          (index) => Column(
                                children: [
                                  Image.asset(
                                    onBoardView[index].imagePath,
                                    height: 277.h,
                                  ),
                                  105.getH(),
                                  Text(
                                    onBoardView[index].title,
                                    style: AppTextStyle.latoBold.copyWith(
                                        fontSize: 32.w,
                                        color:
